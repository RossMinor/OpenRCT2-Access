...
// OpenRCT2-Access: changed from <prism_version.h> to a quoted include so this header works
// without adding its directory to the build's include path. This is the only edit to the file.
