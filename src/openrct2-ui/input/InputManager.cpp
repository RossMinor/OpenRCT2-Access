...
void InputManager::process(const InputEvent& e)
{
    ...
    // Accessible keyboard navigation gets first refusal on key events so it can move
    // the focus cursor and activate widgets before any global shortcut fires. Menus take
